  ...
  <aside class="sidebar" :class="{ collapsed: isCollapsed, 'mobile-open': mobileOpen }">
    ...
    <nav class="sidebar-nav">
      ...
      <router-link to="/CatalogoEpis" class="nav-item" :class="{ active: $route.path === '/CatalogoEpis' }"
        title="Catálogo de EPIs" @click="mobileOpen = false">
        <span class="nav-icon">
          <svg width="17" height="17" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"
            stroke-linecap="round" stroke-linejoin="round">
        ...
        <span class="nav-label">Catálogo de EPIs</span>
      </router-link>

      <router-link to="/minhas-solicitacoes" class="nav-item"
        :class="{ active: $route.path === '/minhas-solicitacoes' }" title="Minhas Solicitações"
        @click="mobileOpen = false">
        <span class="nav-icon">
          <svg width="17" height="17" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"
            stroke-linecap="round" stroke-linejoin="round">
    ...
    <div class="sidebar-bottom">
      ...
      <router-link to="/PerfilAluno" class="nav-item" :class="{ active: $route.path === '/PerfilAluno' }" title="Perfil"
        @click="mobileOpen = false">
        <span class="nav-icon">
          <svg width="17" height="17" viewBox="0 0 16 16" fill="none" stroke="currentColor" stroke-width="1.5"
            stroke-linecap="round" stroke-linejoin="round">
